...
$text = array(
    "home" => array(
        "head" => "WITH THE SOUND IN YOUR EARS",
        "subhead" => "On Tod Dockstader",
        "quote" => "No one is responsible for an emergence; no one can glory in it, since it always occurs in the interstice",
        "credit" => array(
        ...
        "endnote" => "Text assembled with reference to Michel Foucault's Archaeology of Knowledge, Morton Feldman's Essays, and with reference to the Starkland sleevenote material assembled on this site.",
        "pages" => array(
            array(
                "images" => array(0,1),
                "header" => "[Feed-forward]",
    ...
    "compositions" => array(
        ...
        array(
            ...
            "date" => "2003",
            "sample" => array("study7_1.mp3", "study7_2.mp3", "study7_3.mp3", "study7_4.mp3"),
            "description" => array(
                "Tod Dockstader's <em>Eight Electronic Pieces</em> is an unqualified masterpiece of Musique Concr&egrave;te, a transmission from a reality that is strangely familiar yet completely removed from everyday experience. It is chaotic yet surgically precise, otherworldly in its sound and scope yet unmistakably the product of human innovation and discovery. It is most of all a challenge to the musical form - Dockstader eschews traditional melody, harmony and rhythm - but in cutting, pasting and manipulating recorded sounds he evokes genuine drama and emotion, properties that distinguish the finest music regardless of its origins and elemental makeup.",
                "Born March 20th, I932 in St. Paul, Minnesota, Dockstader worked for animation production houses UPA and TerryToons before accepting a job at New York City's Gotham Recording Studios. There he created <em>Eight Electronic Pieces</em>, first privately issued and later picked up by Moe Asch's Folkways Records in I96I. Subsequent efforts including <em>Luna Park</em>, <em>Apocalypse</em> and the epic <em>Quatermass</em>, followed. Dockstader operated, in large part, outside the sphere of the music world record labels commonly rejected his efforts, and his attempts to join the famed Columbia-Princeton Canter for Electronic Music were summarily dismissed. In the wake of the agonizing <em>Omniphony</em> project he stopped making music altogether.",
                "Tod Dockstader effectively disappeared from music several decades before his recordings were rediscovered and celebrated by successive generations. On May 7, 2003, I spoke with Tod about his life before, during and after the creation of <em>Eight Electronic Pieces</em>.",
                "<em>Jason Ankeny, May 2003</em>",
                ...
                "The first seven pieces were on 7 - and - 1/2 IPS tape, and it seemed to be working, so I took it seriously and did 15 IPS, which is the professional speed, and I think that was on Number Seven or Eight. In New York at that time, FM radio was much more adventurous than it is now - even staid stations like WQXR, which is the New York Times station, would play some pretty adventurous music, and some of this musique concr&egrave;te was appearing on the air. I knew how to make lacquer masters, so I made 50 pressings - I could do it cheaply, because I was an engineer so I got discounts. I sold them door - to - door and sent them to every record company in New York or anywhere, and the only one who responded was Moe Asch at Folkways.",
        ...
        array(
            ...
            "description" => array(
                ...
                "<em>Tod Dockstader, July 30, 1961</em>"
            ),
            "sources" => array(
                array(
                    "title" => "empty",
        ...
        array(
            ...
            "date" => "1961",
            "sample" => array("apocf1.mp3", "apocf2.mp3"),
            "description" => array(
        ...
        array(
            ...
            "title" => "Water Music",
            "date" => "1963",
            "sample" => array("part1_1.mp3", "part1_2.mp3", "part2_1.mp3", "part2_2.mp3", "part3_1.mp3", "part3_2.mp3", "part4_1.mp3", "part4_2.mp3", "part5_1.mp3", "part5_2.mp3", "part6_1.mp3", "part6_2.mp3"),
            "description" => array(
                "Water Music began with the sound of water; there is little else in the piece. I've described organizes sound as the technique using everything and the kitchen sink; this is the piece that uses the sink - a kind of kitchen <i>La Mer</i>. i suspected these sound sources were capable of complex organization - in short, of making a kind of music. And yet the processes of mechanical and electronic abstraction they went through during organization did not rob them of their essential quality: a sometimes delicate, sometimes ponderous, wetness.",
                ...
                "Water Music had its premiere on WXQR in June 1963. At the end of the broadcast, the announcer stated that, since electronic music wasn't going anywhere, the broadcast would be the last of its kind. They'd also played Stockhausen's <i> Gesang der Junglinge</i> - so I went out in good company."
            ),
            "sources" => array(
                array(
                    "title" => "",
        ...
        array(
            "images" => array(15,16,17),
            "title" => "Quatermass",
            "date" => "1964",
            "sample" => array("song+lament1.mp3", "song+lament2.mp3", "song+lament3.mp3", "song+lament4.mp3", "song+lament5.mp3", "tango1.mp3", "tango2.mp3", "tango3.mp3", "parade1.mp3", "parade2.mp3", "parade3.mp3", "parade4.mp3", "flight1.mp3", "flight2.mp3", "flight3.mp3", "flight4.mp3", "secondsong1.mp3", "secondsong2.mp3", "secondsong3.mp3", "secondsong4.mp3", "secondsong5.mp3", "secondsong6.mp3", "secondsong7.mp3"),
            "description" => array(
                "Quatermass was intended, from the start, to be a very dense, massive, even threatening, work of high levels and high energy. It was my antidote to the preceding <i>Water Music</i> - a work of small details, delicate textures, and some playfulness. The title was chosen because the word <i>sounded</i> right for the work. It happened to be the name of Professor Bernard Quatermass, star character of a 1950s BBC-TV science fiction serial and two B films (<i>The Creeping Unknown</i> [1956] and <i>Enemy from Space</i> [1957]); at the time, I hadn't seen them.",
                "The basic sound source in <i>Quatermass</i> is a balloon (By stretching the neck of an inflated balloon, you can change the pitch of the escaping air, it becomes a double-reed instrument). As with all my pieces, work began with collecting what I call &quot;cells&quot; (Schaeffer called them &quot;soundobjects&quot;): hours and hours of quarter inch tape recordings of whatever interested me, the original sound transmuted with (what are now called) &quot;classical&quot; tape-studio techniques. By the time I did &quot;Quatermass&quot;, I guess I had a library of around 300,000 feet of tape (125 hours at 15ips.). From this mass, I would select cells that seemed like they might work together into a piece, and then turn them into stereo (with more classical techniques of tape-delay and tape-echo between channels, panning, reverberation, and placement). For &quot;Quatermass&quot;, I had, for the first time, use of a <i>three</i>-track recorder (the third track filled the center &quot;hole&quot; in early stereo recording), which allowed me to do more complex tape-echo rhythms than before (heard in &quot;Tango&quot; and &quot;Flight&quot;) and thicker sound-masses - the &quot;wall&quot; of sound I wanted for the piece.",
                ...
                "The final (and longest) stage was to edit the mixes into the five movements (this was where the <i>Moons</i> were born). I'd guess the forty-six minutes of <i>Quatermass</i> were wrenched out of probably a dozen hours of mixed tape.",
            ...
            "sources" => array(
                ...
                array(
                    "title" => "Second Song",
                    "content" => array(
                        "Almost all the above, plus chimes (<i>Two Moons</i> use these same materials)."
                    )
                )
            )
        ),
        array(
            ...
            "date" => "1964",
            "sample" => array("firstmoon1.mp3", "firstmoon2.mp3", "secondmoon1.mp3", "secondmoon2.mp3", "secondmoon3.mp3"),
            "description" => array(
                "Two Moons of Quatermass were spin-offs from <i> Quatermass</i>: they were flung out, in the long process of editing, as outs. Later, after <i>Quatermass</i> was done, I went back and edited them into the <i>Two Moons</i>. They separated themselves from the main work because; the first <i>Moon</i> was too languid to work with <i>Quatermass</i>, and the second <i>Moon</i> was more playfully chaotic than <i> Quatermass</i>."
            ),
            "sources" => array(
                array(
                    "title" => "empty",
        ...
        array(
            ...
            "date" => "1965",
            "sample" => array("telemetry1_1.mp3", "telemetry1_2.mp3", "telemetry2_1.mp3", "telemetry2_2.mp3", "telemetry3_1.mp3", "telemetry3_2.mp3", "telemetry4_1.mp3", "telemetry4_2.mp3", "telemetry4_3.mp3"),
            "description" => array(
        ...
        array(
            ...
            "title" => "Omniphony",
            "date" => "1966",
            "sample" => array("omniphony1_1.mp3", "omniphony1_2.mp3", "omniphony1_3.mp3", "omniphony1_4.mp3", "omniphony1_5.mp3", "omniphony1_6.mp3", "omniphony2_1.mp3", "omniphony2_2.mp3", "omniphony2_3.mp3", "omniphony2_4.mp3", "omniphony2_5.mp3", "omniphony3_1.mp3", "omniphony3_2.mp3", "omniphony4_1.mp3", "omniphony4_2.mp3", "omniphony4_3.mp3", "omniphony4_4.mp3", "omniphony5_1.mp3", "omniphony5_10.mp3", "omniphony5_2.mp3", "omniphony5_3.mp3", "omniphony5_4.mp3", "omniphony5_5.mp3", "omniphony5_6.mp3", "omniphony5_7.mp3", "omniphony5_8.mp3", "omniphony5_9.mp3"),
            "description" => array(
                "Omniphony is a pioneering work in musical composition. Never before have modern recording techniques been used to shape the content and form of instrumental music, nor have the elements and techniques of electronic with those of instrumental composition. Previously, works for tape and orchestra such as Var&egrave;se's <em>D&eacute;serts</em> and Stockhausen's <em>Kontakte</em>, were designed for concert hall performance, the tape playing simultaneously with the orchestral performance. The techniques of electronic composition that produced the tape were not applied to the orchestra and the acoustics of the concert hall prevented the orchestra and taped sounds from being blended perfectly. However, in Omniphony, the range, timbre, dynamics, and natural durations of the orchestral sounds have been expanded through electronic means and therefore have a new and common ambiance with the non-orchestral sounds.",
        ...
        array(
            ...
            "title" => "Past Prelude",
            "date" => "1990",
            "sample" => array("pastprelude1.mp3", "pastprelude2.mp3", "pastprelude3.mp3", "pastprelude4.mp3", "pastprelude5.mp3"), 
            "description" => array(
        ...
        array(
            ...
            "sample" => array(),
            "description" => array(
                "I've written before of my interest in shortwave radio, in the notes to the Quatermass CD. Also, in the notes to the Omniphony CD (which has my first 'Aerial' mix, '<a href=\"compositions.php?page=13\">Past Prelude</a>' in it), I mentioned 'The Aerial Etudes', which was my working title for what became the three CDs you have. And, at the end of an <a href=\"interview.php?interview=2\">interview with Chris Cutler</a> (which can be found in the 'Unofficial TD Website'), the piece I mentioned was starting to work on at the time became 'Aerial'.",
                ...
                "<strong>Tod Dockstader</strong>, 14 September 2003"
            ),
            "sources" => array(
                array(
                    "title" => "empty",
    ...
    "interviews" => array(
        ...
        array(
            ...
            "text" => array(
                ...
                "&ldquo;To me it&rsquo;s just a continuation of what I&rsquo;ve been doing all this time, with long periods of nothing,&rdquo; he remarks casually of the two most recent releases to bear his name, then pauses to light up another cigarette from one of the two packs placed carefully on a side table close to where he&rsquo;s sitting on the back porch of his home. The sights and sounds of a fresh spring day in rural Connecticut filter easily in through the fine mesh screens. Out of those long periods of nothing to which he has just referred, however, has come <em>Pond</em>, a collaboration with David Lee Myers and the first new Dockstader work to be published in nearly 40 years, plus <em>Aerial #1</em>, part of a three-volume series of compositions derived from shortwave radio transmissions being made available as a part-work by Belgium&rsquo;s Sub Rosa label. Its scale and complexity, not to mention the painstaking technical skill with which each piece has been assembled, reveal a composer of unique talents and singular perception.",
                ...
                "At UPA Dockstader had already started to &ldquo;hear music in sound: pitches, duration&rdquo;. But in the Gotham studios the plastic manipulation of recorded sound began in earnest. Gradually a first series of compositions, <em>Eight Electronic Pieces</em>, took shape. Working with open-reel tape was hard physical work, moving from machine to machine, coordinating playback, cutting and mixing individual tracks, hoping against hope that you had enough footage to realise an effect. &ldquo;You had to stand up to do it,&rdquo; Dockstader recalls. &ldquo;You couldn&rsquo;t sit down. It really was industrial, very physical. Like a ballet.&rdquo; He would later write of the process as having &ldquo;a muscular joy to it&rdquo;.",
                "Cutting across all abstract theorising, the recording had unequivocally become the score. Dockstader&rsquo;s early work was characterised not only by the precision and richness of the sounds, but also by the force with which the sounds come at you. <em>Study No 7</em> from <em>Eight Electronic Pieces</em>, first realised in 1961 (and now available on Locust Music), has a sense of attack that&rsquo;s rare for electronic work from this period. &ldquo;I always liked dynamics: the percussive,&rdquo; he remarks. &ldquo;I like to have edges. Sound to me is always very physical. I can feel, not just hear it. It has personality. It has weight, proportion. It&rsquo;s like I can pick it up and hold it. It&rsquo;s always been that way, I don&rsquo;t know why. It&rsquo;s not abstract at all. It exists. It isn&rsquo;t invisible to me.&rdquo; Westport&rsquo;s fire trucks go by again, unseen and unacknowledged in the far distance, their sirens and horns still blaring.",
                "Completed in 1963, Dockstader&rsquo;s <em>Water Music</em> brought form to the most formless of matter, combining recordings of running water, splashing and drips with sound produced on an ad hoc selection of objects, including a toy gong, Indian finger bells, a Coke bottle and a piece of sheet metal. It displayed an inventiveness that reached back to both his time cutting sound for UPA cartoons and to his days as an amateur radio enthusiast, converting old cigar boxes and germanium crystals into pieces of functioning equipment. &ldquo;I&rsquo;d just walk around,&rdquo; he replies when asked to describe the process of collecting sounds for <em>Water Music</em>. &ldquo;There was a sewer one night where I lowered a microphone down into it. The sounds came from all over. Just running a faucet, putting it through a trumpet, trying different mutes on it. I made little mutes to see what would happen to the drops scattering. It&rsquo;s affected by the depth, the height and velocity of the drips. I just kept on recording, recording, recording. I built a library. It&rsquo;s always been that way - start with some idea and just go out from there, searching for things that go with it or against it. It&rsquo;s hard to describe. It&rsquo;s kind of intuitive.&rdquo;",
                "<em>Water Music</em> had its premiere in June 1963 on FM music station WQXR as part of a programme that also featured Karlheinz Stockhausen&rsquo;s <em>Gesang Der J&uuml;nglinge</em>. At the end of the show, the presenter announced that since electronic music had no future, this would be the last broadcast of its kind. &ldquo;I&rsquo;ll never understand that,&rdquo; Dockstader laughs, recalling the announcer&rsquo;s words. &ldquo;Why did they play it? I think the show was called <em>What&rsquo;s New In Music</em>.&rdquo; This particularly choice detail provokes another wave of laughter. &ldquo;In the end the whole programme died, although I don&rsquo;t think I was responsible for that.&rdquo;",
                ...
                "Acceptance was far from total, however. Dockstader&rsquo;s background as a studio engineer made him an unschooled &lsquo;primitive&rsquo;, so far as the music establishment was concerned. The frequent references to contemporary popular culture in his choice of titles also set him apart. <em>Luna Park</em>, for example, is the name of an old abandoned Coney Island attraction; <em>Travelling Music</em> is derived from a term Jackie Gleason used to describe musical filler on his TV show, while Dockstader&rsquo;s 1964 masterpiece <em>Quatermass</em> was titled after the British science fiction series. &ldquo;I&rsquo;d never seen the film,&rdquo; he explains. &ldquo;I found this book and thought that&rsquo;s a great title. I didn&rsquo;t see a Quatermass film until years afterwards. I wanted titles that sounded well, instead of <em>Study In This&hellip;</em>&rdquo;",
        ...
        array(
            ...
            "text" => array(
                ...
                "Somewhere along the way we discovered that we both shared a fascination with frog sounds, and I had the brainy idea that we might actually make some music together along those lines. Most of my work has been 100% electronic, but I've always itched to work with some &quot;real world&quot; sounds, and this seemed to me ideal. The frog and toad noises are quite &quot;abstract&quot; and expressive, and really lend themselves to manipulation, I think...",
                "They are, and they did - more and more as we came to understand their songs. I was used to real-world sounds as a material for music, but, other than a few cats, I don't remember using any living sources. Living next to a small swamp, as I did, I heard them, and thought about it - but....",
                "I recorded a lot of the frogs and toads with a portable recorder, sneaking around in bushes and lakes at night. I believe you had an experience with such activity which actually got you in trouble with the law... ?",
                "Not deep trouble. I'd go out at night with a Nagra I had use of, and hunker down in bushes in people's yards, trying for tiny bug songs - but someone saw me hiding there and called the cops. I explained what I was doing to them and showed lots of ID and they told me to quit doing it and let me go.",
                "Also on Pond are a few insect-type sounds which I think you told me were actually derived from synthesizers?",
                "They weren't from a synth. I'd re-wired a couple of cheap test-tone generators so that they produced a variety of variable bird-calls, peeper-peeps, and unidentified insect susurrations. This was for a piece I was thinking of doing, involving insects and the end of the world, but somehow never got around to.",
                "Our cover art is based on a photograph you took long ago. It has a kind of murky, mysterious darkness about it. You can imagine these strange creatures hiding in this thicket and having the most secret and bizarre conversations...",
                "Well, they're not secret anymore. And the photograph was of one, gnarled tree, taken at sundown. I made two exposures, flipped one over the other, as slides, and saw a kind of face emerge. And, after we'd gotten a ways into &quot;Pond,&quot; I remembered it - it seemed to go with the music.",
                "Part of what was fun for me was taking these real-life sounds that living animals make, and through various manipulations, winding up with tones that might have emerged from an electronic device. Some of what we hear is almost a straight nature recording, but in the next moment it becomes a symphony of oscillators...",
                "Yeah, that was unexpected - life imitating art.",
                "On your classic recordings from the 1960s, many of your sounds were derived from natural sounds like water drops, squeaking balloons, cats, trashcans, etc. Did you find that working on a computer with &quot;real&quot; sounds was vastly different? I'm sure it was faster than with tape, if nothing else...",
        ...
        array(
            ...
            "text" => array(
                ...
                "But you adopted it -",
                "- from Var&#232;se. He used it because of all the problems with the word &quot;Music&quot; - with a capital M: &quot;But, is it Music&quot; And there were all these labels, musique concr&#232;te, tape music, electronic music and whatnot, at that time. I was working in all those techniques, yes, but I was working in the sound, first, in the <em> sound</em>, and I thought Var&#232;se's term covered what I was doing, best.",
                "But not now?",
                "Well, now I suspect it was a kind of cop-out. Why I started was because I really wanted to make a kind of music, and I was worried about being an unlettered primitive and so I shouldn't call it any kind of &quot;music,&quot; what I was doing. I wanted to make music out of sound, instead of sound out of music - which is what people who write Music intend to do. And, with tape, for the first time, I could do that. Of course, most of the world's people make music without writing it out first; they always have.",
                "&quot;Primitive&quot; cultures",
                "Right. And I was a charter primitive. I was included, at the end, in a long programme on New York FM - this was early 'Sixties. They played Cage and Stockhausen and Schaeffer, Henry, Kagel and all, and at the end, after my little contribution, the host said something like, Well, any form that allows an unschooled primitive to make music can't be all bad.",
                "You were &quot;unschooled&quot;?",
                "No. I hadn't gone to their school, a Music school. I'd gone to my own school: I learned cooking in the kitchen. I apprenticed as a sound engineer in a big New York studio, in the 'Fifties. I went pretty fast through that school because I'd already done film editing in Hollywood, and a film editor in a little studio has to cut a lot of sound. It was all optical sound in those days, but the principals were the same.",
                "What kind of films were they?",
                "Animated cartoons. The studio was UPA, a little place across the street from the big Warner lot. I got the apprentice editing job because I could draw; I guess they needed an editor who could understand the artists. The studio's gone now, and the New York sound studio; so much is gone. I always felt comfortable in studios, at home right away.",
                "Were you ever involved on the other side of the camera, with the visual side of film?",
                "I did a few original storyboards, on my own time, that were made into films. One was about an ice-cream salesman, drove a Good Humor type of truck around and got so he couldn't stand that same lame tune looping all day. So, he installed a pipe-organ in his truck instead of the jingle-machine. I wanted the organ to play the Bach <em>Toccata and Fugue in d</em>, but the staff composer said, no way, he wanted the credit. So he wrote a tune which wasn't much better than the first one. That was my first exposure to the business of music: they wouldn't let me play what I wanted.",
                "What models did you have when you did begin to play what you wanted?",
                "I'd heard some early work in Hollywood, done by film-makers working with optical tracks, drawing on them. There were the Whitney brothers and a Canadian, Norman McLaren, working in the 'Forties and early 'Fifties. They drew these little soundtracks for their films, before tape. They sounded quite &quot;electronic,&quot; whatever that was. And l'd seen and heard a film by the Barrons, <em>Jazz of Lights</em>, which <em>was</em> electronic, this was mid-'Fifties. It was all new to me, and at the same time it sounded somehow familiar: I knew how they did it. So, as soon as I got the chance, in New York, I started in.",
                "Had you heard any musique concr&#232;te?",
                "I think I must have, at least on the radio in New York. Probably Schaeffer's '48 <em> Etudes</em> - the train thing and the saucepan thing - and the first Luening and Ussachevsky tapes of the 'Fifties. I still have the first LP of musique concr&#232;te; I think that was '60 or '61. But I'd already done my first <em>Eight Pieces</em> by then. 1 don't think I modeled my first work after anyone in particular, not consciously anyway. I just knew how to do it. In working on a Moviola, you could run tracks backward and speed them up and slow them down, and edit sounds. Before tape came in, and that's about all they wore doing, technically. What was important to me was they were doing this as music, what Schaeffer called &quot;a new art of sound.&quot; That idea was my model.",
                "He followed that statement with, &quot;Am I wrong in still calling it music?&quot;",
                "Yes. As I said, I worried about that, too.",
                "And now Schaeffer has decided that he was wrong, after all-",
                ...
                "So then you had no studio to work in?",
                "Right. I tried to go on for a while, cobbling together some equipment at home, working nights. I got a suitcase organ, a Gibson 'combo' organ, the same model Ray Manzarek played on the road, and I rewired it into an affordable synthesizer, or something. This was before suitcase synthesizers appeared, like the MiniMoog and the Arps. The keyboard I'd made so odd, distempered and unstable, that I felt at home with it. But what I was doing wasn't like anything I'd done, and almost no one liked it, the few that heard it. One, a musician I knew, said, 'What are you doing playing chords? What is this counterpoint? You're not supposed to do that.' Maybe he was right: the record companies I tried, a bit half-heartedly by then, had no interest in it.",
                "Owl Records didn't take it?",
                "Owl had gone out of business by then, or evaporated or otherwise ceased to be; I never knew just what happened. They came back later, changed. Folkways went; the tiny royalties stopped; all my bridges burned. Later, I destroyed most of what I'd tried to do. I kept a piece of it, called it <em>Animated Khartoum,</em> which was a bad pun on my UPA days, and also because my rewired organ tended to produce Arabic sounds. lt had a nasal condition. That was the last &quot;serious&quot; piece I did.",
                "That was what, 1970?",
                "About then. I'd left New York to work on sound and visual design for some big expositions, in Canada and the U.S. I shot film, stills, did a lot of soundtracks for that. Then, I got into making videos and film-strips (another obsolete form of communication, now) for educational publishers, writing and researching. I wrote and directed a lot of video programs on American history. I liked that, the subject. You may have noticed I have an affinity for the past.",
                "And music?",
                "I did some, for the various things I wrote. Most of the music I used was Period - obviously, with history - and I couldn't improve on that. I'd compose something to solve a narrative problem. For instance, I used my old concrete skills to underscore the battle of Verdun, working from the soldiers' descriptions of how it sounded - the huge roaring and sighing. I'd write opportunities for my music into my scripts. I was using about everything I'd ever learned to do, in that work. It was good work for me; it was generally a good time for me. I was busy, the years went by fast. But then, the publishers started going for computer programs - here we go again - and I just wasn't Interactive enough for that. That was committee-work, and I'd always worked alone. And, just then, I got a couple of offers to do CDs of all my old work - the music.",
                "How did you feel about that?",
                "Astounded. I hadn't listened to it myself, for a long time. I didn't know if the old master tapes would play, so I wouldn't agree to it until I'd hauled them out and listened to them.",
                "How was it?",
                "Painful, at first. There was some deterioration of the tapes, drying out, and all those hundred of splices peeling apart. When I played them, little piles of iron oxide would appear beneath the heads and tape-guides, and I thought, there goes the music - rust to dust. So, the next time I ran them, I made careful analog dubs, the best I could do, on professional equipment, to new tape. Some parts were really bad, but I managed to get dubs from an old friend that hadn't deteriorated (the tape, not the friend) and replaced those sections; there were only a few. So then I said, OK we'll do the CDs from my new dub-masters.",
                "How did you feel about the music, after so long?",
                "At first, I hardly heard it as music; all I worried about was the sound. How's this going to stand up to CD sound-quality? I told the producer, Tom Steenland, we'd have to release them as Historic Recordings, like Edison cylinders. But, after the CDs came out, a hi-fi magazine asked for copies to use as test records for rating new equipment - so, either l'd underestimated my tapes or overestimated the State of the Art. After I'd settled down, I started to hear the music again, and again and again, with all the DAT transfers to approve and the CD references. It was very strange: it was almost like listening to someone else's work. But I liked it. I began to hear what I'd wanted to do in it: it stood up, for me. And, after a while, for others. The first reviews were: Uh, what is this stuff? Where did this come from? One reviewer called it &quot;free - form jazz,&quot; whatever that is. But, just now the reviews have been better by far than anything the music ever got in it's day. when it was made.",
                "That's probably not very surprising - I think Var&#232;se once remarked that the Composer was never ahead of his time, the public were behind it. Also - you have a new generation now, who grew up listening that way; for them it's not so strange.",
                "Still, I was stunned; I never thought it would happen. Most of these reviewers, and people I heard from were, as you say, young - young to me, anyway - most with a whole different background in time and music from my own.",
                "Do you think there's a reason for that? - do you think your work is somehow close to the sensibilities of people with a group, or rock, background?",
                "I wasn't aware of that. I remember I got a couple of 'phone calls in the 'Eighties from someone, I don't remember his name, who said he was working in a group, composing, or trying to, and they were all listening to my LPs, and could I tell him what to do. I didn't know what to say to him, except, don't worry it, just do it. Because, I'd always worked alone, not even listening to other people's music then, let alone working in a group. So, what were they hearing in my music? I don't know; maybe - it's the hands.",
                "&quot;Hands&quot;?",
                "Well - in painting, which I studied, seriously, in school, we used to say a painter we liked had &quot;good hands.&quot; You could see his hand in the work, in the brush-work. This was early 'Fifties, with painters like DeKooning and Bacon; they had great hands. And, for me, like painting, making music was always a very physical thing, very tactile. I played those tape machines like a DJ plays turntables, rocking reels back and forth, pulling the tape through by hand. The only time I sat down was to edit - more hand-work - otherwise I was always in motion. Maybe, because rock is a hand-made music - isn't it? -they heard that in my work. I really don't know.",
                "You mentioned Manzarek. Did you ever listen to rock?",
                "Yes, in the late 'Sixties, when they were starting to explore, the groups were trying new things. I even wrote an article about it, I guess it was the first one about &quot;electronic rock.&quot; It was published in the old <em>Electronic Music Review</em>. I don't know if their readership knew what I was talking about, then. So, I heard a lot, saw some of the groups - the Doors, the Who, the Holding Company, a lot of others long gone now. But before then, when I was doing the music, no. When I was working, I didn't listen to any other music.",
                "Why not?",
                "There wasn't time to listen to anything other than what I was doing. And, it was a self-protective thing, too. I had to protect my innocence - what the critics called my ignorance; I had to keep my ears clean. After I came out of the studio, finally, I started listening again. There was a lot of new music to listen to then. I even reviewed some of it.",
                "In revenge?",
                "No, not at all. I really wanted to <em>like</em> everything. But I found out it was hard to write a 'good' review, much easier to write a bad one. Something about the English language: all the really colourful adjectives are bad, disapproving. And they were sending me these awful records, electro-pop and cosmic-nothing music. It got so I had to tell the editor - this was <em>The Musical Quarterly</em> - I couldn't do it anymore. People say reviews don't mean anything, record reviews, but these records <em>were</em> the music, itself - not just another performance of it - so these were the only reviews the music was going to get. I think to go on doing that, a reviewer has to be someone who's never been reviewed.",
                "How about now? What do you like of contemporary music?",
                "No. No more reviewing.",
                "Alright, no names. Just generally.",
                "I haven't heard much new music, but, alright: most of what I've heard, instrumental and electronic, sound Neo-something to me: looking backward. Drone, and minimal, and New-Age-therapeutic - they were starting to do that back when I was reviewing, and I had trouble with it then. I didn't think it all would become so important. The minimal music I've heard recalls, for me, Schaeffer's locked groove Etudes - more ornate, but still... It conjures up images from Fritz Lang's film, <em>Metropolis</em>: all these people being sequenced like automatons, endlessly labouring away. Very sad, a mis-use of human beings. Some of it's pretty. But, no.",
                "What other non acoustic musics have you heard? Any computer music?",
        ...
        array(
            ...
            "recordings" => array(
                array(
                    ...
                    "contents" => "Jigjag, Floating Up, Glider, Howl Stomp, Steam Megawatt, Snap Sail, IC Arabian, Pile Readout, Pond Dance, Holiday Meltdown, S&eacute;ance, Old Dark Clock, Soprano Aloft,  Powerdown, Signal Powerdown, Snap Prance, Night Wolves, Bottle Dervish, Frog March-By, Sun Surges, Blackhole Dropout, Sundrift, Soft Aurora",
                    "url" => ""
                ),
                array(
        ...
        array(
            ...
            "recordings" => array(
                array(
                    ...
                    "contents" => "Apocalypse (part 2), alongside early electronic works by other composers including Robert Ashley, David Behrman, John Cage, Luc Ferrari, Edgard Var&egrave;se (Po&egrave;me Electronique) and Iannis Xenakis. A compilation on a 3xCD box set with 90-page booklet was originally released, then re-released as a &ldquo;Special Edition&rdquo; which included a 2 hour DVD containing films, interviews and animations of the various artists featured on the CDs.",
                    "url" => ""
                )
            )
        ),
        ...
        array(
            ...
            "recordings" => array(
                ...
                array(
                    ...
                    "contents" => "Pond is  a collaboration between Tod Dockstader and David Lee Myers, born of a long written correspondence and a mutual affection for frogs between them which eventually spawned this programme of electronic/concrete pieces. The pieces are derived almost entirely from field (and swamp) recordings of frogs - choral and solo - processed, manipulated and organised in a million ways. David Lee Myers released a number of recordings in the 1980s under the name <em>Arcane Device</em>, where the musical material was derived from almost uncontrollable feedback systems. In this recording, Dockstader used computers to manipulate the sounds for the first time, with the assistance of Myers, and recently remarked that he 'realised that many of the old principles - slowing, speeding, pitch-change, reversal - were the same - but with much more control and better sound (and no tape hiss). Because it was faster and I could keep my belief in what I was doing, more fun.'",
    ...
    "biography" => array(
        ...
        array(
            "heading" => "Dockstader on Dockstader",
            "images" => array(28,29),
            "paras" => array(
                "I don't remember just when I first heard <em>musique concr&#232;te</em>; it must have been in the early 50s. I think I liked the <em>idea</em> of it more than the Toonerville-Trolley sound of the early pieces. In Pierre Schaeffer's original definition, it meant working with the sound in your ears, directly with the sound, as opposed to &quot;abstract&quot; music in which the sounds are written. Like Schaeffer, a working sound engineer, I had the training to be a &quot;worker in rhythms, frequencies and intensities.&quot; As a non-musician, I couldn't write music, but this &quot;new art of sound&quot; didn't need notation. In the beginning, <em>musique concr&#232;te</em> wasn't even agreed upon to be music; Schaeffer's first presentation of his work was called &quot;a concert of noises.&quot;",
                ...
                "I also chose it because, in the '60s, the term &quot;electronic music&quot; was coming to mean music made purely of synthetic sound, and I was working in <em>both</em> &quot;concrete&quot; and electronically generated sounds."
            )
        ),
        array(
            "heading" => "Dockstader on Dockstader (cont.)",
            "images" => array(30,31),
            "paras" => array(
                "By 1960, in addition to Var&#232;se's <em>Poeme</em>, I'd heard tape music pieces by Berio, Leuning, Ussachevsky, and Stockhausen. Also, I had always listened to instrumental music. From the start, I had preferred 20<sup>th</sup> century music, or at least what there was of it that was dramatic, colorful, and adventurous - everything from Stravinsky's <em>Firebird</em> to Messiaen's <em> Turangulila Symphony</em> to Boulez's <em>Le Marteau sans maitre</em> (three that pop into mind). Of all I heard, the three electronic pieces I can hum are Var&#232;se's <em>Poeme</em>, Stockhausen's <em>Gesang der Junglinge</em>.",
    ...
    "reviews" => array(
        ...
        "articles" => array(
            array(
                ...
                "title" => "",
                "paras" => array(
                    '<p>If you know of any other reviews or articles available online, please <a href="&#109;&#97;&#105;&#108;&#116;&#111;:&#x77;&#x65;&#x62;&#109;&#97;&#x73;&#116;&#x65;&#x72;&#x40;&#100;&#111;&#x63;&#x6B;&#115;&#x74;&#x61;&#100;&#x65;&#114;&#x2E;&#x69;&#110;&#x66;&#111;" title="&#99;&#111;&#x6E;&#116;&#97;&#99;&#116;&#32;&#x6D;&#x65;&#32;&#118;&#105;&#97;&#x20;&#101;&#109;&#x61;&#105;&#x6C;">&#99;&#x6F;&#x6E;&#116;&#97;&#x63;&#x74;&#x20;&#x6D;&#x65;&#32;&#x76;&#x69;&#97;&#x20;&#101;&#x6D;&#x61;&#105;&#x6C;</a> and I will add them here.</p>' . 
										'<h3>General</h3><ul>' . 
                    '<li><a href="http://www.mimaroglumusicsales.com/artists/tod+dockstader.html">hrvatski</a> [mimaroglumusicsales.com]</li>' .
										'<li><a href="http://www.citypages.com/2005-08-10/arts/brave-old-world/">Andy Beta</a> [citypages.com]</li>' .
										'<li><a href="http://www.scaruffi.com/oldavant/dockstad.html">Piero Scaruffi</a> [scaruffi.com]</li></ul>' .
                    '<h3>Aerial</h3><ul>' .
										'<li><a href="http://www.paristransatlantic.com/magazine/monthly2006/12dec_text.html#10">Massimo Ricci (volumes 1-3)</a> [paristransatlantic.com]</li>' .
										'<li><a href="http://www.stylusmagazine.com/review.php?ID=3161">Cameron Macdonald (volume 1)</a> [stylusmagazine.com]</li>' .
										'<li><a href="http://www.dustedmagazine.com/reviews/2174">Spencer Grady (volume 1)</a> [dustedmagazine.com]</li>' . 
										'<li><a href="http://www.brainwashed.com/index.php?option=com_content&task=view&id=4389&Itemid=64">John Kealy (volume 2)</a> [brainwashed.com]</li>' .
										'<li><a href="http://www.popmatters.com/pm/music/reviews/tod_dockstader_aerial_2/">Nate Dorr (volume 2)</a> [popmatters.com]</li>' .
										'<li><a href="http://www.themilkfactory.co.uk/reviews/tdockstader_aerial2.htm">Max Schaefer (volume 2)</a> [themilkfactory.co.uk]</li>' .
										'<li><a href="http://www.groovesmag.com/review_detail.php?id=00000286">Richard Moule (volume 2)</a> [www.groovesmag.com]</li>' .
                    '<li>boomkat reviews of <a href="http://www.boomkat.com/item.cfm?id=16891">volume 1</a>, <a href="http://www.boomkat.com/item.cfm?id=19792">volume 2</a> and <a href="http://www.boomkat.com/item.cfm?id=23440">volume 3</a> [boomkat.com]</li>' .
										'<li>Tom Sekowski (GAZ-ETA) - <a href="http://www.gaz-eta.vivo.pl/gaz-eta/recenzje/gazeta.php?nr=39&id=s_15">volume 2</a> and <a href="http://www.gaz-eta.vivo.pl/gaz-eta/recenzje/gazeta.php?nr=47&id=s_9">volume 3</a></a> [www.gaz-eta.vivo.pl]</li>' .
										'</ul>' .
										'<h3>Bijou (with David Lee Myers)</h3><ul>' .
										'<li><a href="http://www.cloudsandclocks.net/CD_reviews/dockstadermyers_bijou_E.html">Beppi Colli</a> [cloudsandclocks.net]</li>' .
										'<li><a href="http://www.gaz-eta.vivo.pl/gaz-eta/recenzje/gazeta.php?nr=37&id=s_2">Tom Sekowski</a> [www.gaz-eta.vivo.pl]</li>' .
										'</ul>' .
                    '<h3>Pond (with David Lee Myers)</h3><ul>' .
                    '<li><a href="http://www.cloudsandclocks.net/CD_reviews/dockstadermyers_pond_E.html">Beppi Colli</a> [cloudsandclocks.net]</li>' .
                    '<li><a href="http://www.allaboutjazz.com/php/article.php?id=15609">Nils Jacobson</a> [allaboutjazz.com]</li>' .
										'<li><a href="http://www.bbc.co.uk/music/release/xjmq/">Bill Tilland</a>  [bbc.co.uk]</li></ul>' .
                    '<h3>Eight Electronic pieces</h3><ul>' .
                    '<li><a href="http://www.boomkat.com/item.cfm?id=11659">boomkat review</a> [boomkat.com]</li>' .
										'<li><a href="http://www.dustedmagazine.com/reviews/1203">Jon Dale</a> [dustedmagazine.com]</li></ul>' . 
                    '<h3>An Anthology of Noise and Electronic Music</h3><ul>' .
                    '<li><a href="http://www.boomkat.com/item.cfm?id=10842">boomkat review</a> [boomkat.com]</li>' .
                    //'<li><a href="http://www.bbc.co.uk/music/experimental/reviews/artistsvar_anthology.shtml">Peter Marsh</a> [bbc.co.uk]</li>' .
										'<li><a href="http://brainwashed.com/index.php?option=com_content&task=view&id=2754&Itemid=64">Johnathan Dean</a> [brainwashed.com]</li>' .
										'<li><a href="http://www.stylusmagazine.com/reviews/various-artists/an-anthology-of-noise-electronic-music-fourth-a-chronology-1937-2005.htm">Cameron Macdonald</a> [www.stylusmagazine.com]</li>' .
										'</ul>' .
                    '<h3>Ohm:: The Early Gurus Of Electronic Music</h3><ul>' .
                    '<li><a href="http://www.boomkat.com/item.cfm?id=19768">boomkat review</a> [boomkat.com]</li>' .
                    '<li><a href="http://www.classical-music-review.org/reviews/OHM.html">Tony Gualtieri</a> [classical-music-review.org]</li></ul>' .
                    '<h3>From A-Z</h3><ul>' .
                    '<li><a href="http://cyberpsychos.netonecom.net/cpaod6/atozrev.html">Jasmine Sailing</a> [Cyber-Psychos AOD #6]</li></ul>'
                    //'<h3>Apocalypse</h3><ul>' .
                    //'<li><a href="http://www.em411.com/show/music/265/1/apocalypse.html">DAZZ</a> [em411.com]</li></ul>'
                )
            ),
            array(
                "publication" => "Audion",
                ...
                "paras" => array(
                    "The following is an abridged version of the text originally published in Audion #32 (<a href=\"http://myweb.tiscali.co.uk/ultimathule/audion.html#a32\">http://myweb.tiscali.co.uk/ultimathule/audion.html#a32</a>)",
            ...
            array(
                ...
                "paras" => array(
                    ...
                    "<em>Craig Anderton has worked on ten major label recordings, from classical to rock to new age, and written ten books on various aspects of musical electronics. He is also a music industry consultant, and lectures around the world.</em>"
                )
            ),
            array(
                ...
                "paras" => array(
                    ...
                    "The synthesizer, first in its Moog-type format (following an outlandish early RCA machine) and now triumphantly in digital, is undoubtedly a very major development in sonic techniques. Beside its amazing present versatility, the older <em>music concr&egrave;te</em> assemblage of real sounds is hopelessly out of date, even though some brave souls still continue to &quot;organize&quot; whale sounds and such in an effective way.",
                    ...
                    "Thus, inevitably, <em>musique concr&egrave;te</em> is now mostly history - and there is its importance. The technique is obsolete, the sounds, at their best, are not. And so they return. One of the saving graces of an otherwise ever noisier and more meaningless audio world! Listen and enjoy.",
                    "<em>Edward Tatnall Canby, who aired some of the first broadcasts of Dockstader's works, has written for Audio magazine for over forty years.</em>"
                )
            ),
            array(
        ...
        array(
            ...
            "alt" => "Tod Dockstader's studio, circa. 1961",
            "caption" => "Tod Dockstader's studio, circa. 1961"
        ),
        array(
        ...
        array(
            ...
            "alt" => "Tod Dockstader",
            "caption" => "Tod Dockstader"
        ),
        array(
            "filename" => "picture4.jpg",
            "alt" => "Tod Dockstader in the studio, circa. 1966",
            "caption" => "Tod Dockstader in the studio, circa. 1966"
        ),
        array(
        ...
        array(
            ...
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture7.jpg",
            "alt" => "Tod Dockstader's studio, circa. 1966",
            "caption" => "Tod Dockstader's studio, circa. 1966"
        ),
        array(
            "filename" => "picture8.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture9.jpg",
            "alt" => "James Reichert in the studio mixing Omniphony",
            "caption" => "James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture10.jpg",
            "alt" => "Tod Dockstader's studio, circa. 1966",
            "caption" => "Tod Dockstader's studio, circa. 1966"
        ),
        array(
        ...
        array(
            "filename" => "picture12.jpg",
            "alt" => "Tod Dockstader's studio, circa. 1966",
            "caption" => "Tod Dockstader's studio, circa. 1966"
        ),
        array(
            "filename" => "picture13.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
        ...
        array(
            "filename" => "picture15.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture16.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture17.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture18.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture19.jpg",
            "alt" => "James Reichert in the studio mixing Omniphony",
            "caption" => "James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture20.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture21.jpg",
            "alt" => "Tod Dockstader's studio, circa. 1966",
            "caption" => "Tod Dockstader's studio, circa. 1966"
        ),
        array(
            "filename" => "picture22.jpg",
            "alt" => "Tod Dockstader in the studio mixing Omniphony",
            "caption" => "Tod Dockstader in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture23.jpg",
            "alt" => "James Reichert in the studio mixing Omniphony",
            "caption" => "James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture24.jpg",
            "alt" => "Tod Dockstader in the studio mixing Omniphony",
            "caption" => "Tod Dockstader in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture25.jpg",
            "alt" => "Tod Dockstader in the studio mixing Omniphony",
            "caption" => "Tod Dockstader in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture26.jpg",
            "alt" => "Tod Dockstader's studio, circa. 1966",
            "caption" => "Tod Dockstader's studio, circa. 1966"
        ),
        array(
            "filename" => "picture27.jpg",
            "alt" => "Tod Dockstader in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture28.jpg",
            "alt" => "Tod Dockstader in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture29.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture30.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture31.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture32.jpg",
            "alt" => "Tod Dockstader and James Reichert in the studio mixing Omniphony",
            "caption" => "Tod Dockstader and James Reichert in the studio mixing Omniphony"
        ),
        array(
            "filename" => "picture33.jpg",
            "alt" => "James Reichert",
            "caption" => "James Reichert"
        )
    )
);
?>
